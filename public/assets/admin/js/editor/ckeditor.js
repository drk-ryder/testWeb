...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                domReady: function() {
                    ...
                    var c = [];
                    return function(b) {
                        function n() { try { document.documentElement.doScroll("left") } catch (f) { setTimeout(n, 1); return } a() } c.push(b);
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (q) {} document.documentElement.doScroll && b && n()
                        }
                    }
                }()
            },
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, g, h, k) {
                function n(a, f, D, k) { a = { name: b, sender: this, editor: a, data: f, listenerData: h, stop: D, cancel: k, removeListener: q }; return !1 === d.call(g, a) ? !1 : a.data }

                function q() { D.removeListener(b, d) } var f = a.call(this, b); if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    g || (g = this);
                    isNaN(k) && (k = 10); var D = this;
                    n.fn = d;
                    n.priority = k; for (var w = f.length - 1; 0 <= w; w--)
                        if (f[w].priority <= k) return f.splice(w + 1, 0, n), { removeListener: q };
                    f.unshift(n) } return { removeListener: q } },
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) { var d = /\n{2}/g; if (d.test(c)) var n = "\x3c" + k + "\x3e",
                        m = "\x3c/" + k + "\x3e",
                        c = n + c.replace(d, function() { return m + n }) + m } c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            normalizeCssText: function(a, f) { var b = [],
                    c, k = CKEDITOR.tools.parseCssText(a, !0, f); for (c in k) b.push(c + ":" + k[c]);
            ...
            normalizeHex: function(a) { return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, b, c, k) { a = b.toLowerCase();
                    3 == a.length && (a = a.split(""), a = [a[0], a[0], a[1], a[1], a[2], a[2]].join("")); return "#" + a + k }) },
            parseCssText: function(a, f, b) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                    function(a, b, k) { f && (b = b.toLowerCase(), "font-family" == b && (k = k.replace(/\s*,\s*/g, ",")), k = CKEDITOR.tools.trim(k));
                        c[b] = k });
                return c
            },
            writeCssText: function(a, f) { var b, c = []; for (b in a) c.push(b + ":" + a[b]);
                f && c.sort(); return c.join("; ") },
            objectCompare: function(a, f, b) { var c; if (!a && !f) return !0; if (!a || !f) return !1; for (c in a)
                    if (a[c] != f[c]) return !1; if (!b)
                    for (c in f)
                        if (a[c] != f[c]) return !1; return !0 },
            ...
            eventsBuffer: function(a, f, b) {
                function c() { d = (new Date).getTime();
                    k = !1;
                    b ? f.call(b) : f() } var k, d = 0; return { input: function() { if (!k) { var f = (new Date).getTime() - d;
                            f < a ? k = setTimeout(c, a - f) : c() } }, reset: function() { k && clearTimeout(k);
                        k = d = 0 } } },
            enableHtml5Elements: function(a,
                f) { for (var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), c = b.length, k; c--;) k = a.createElement(b[c]), f && a.appendChild(k) },
            checkIfAnyArrayItemMatches: function(a, f) { for (var b = 0, c = a.length; b < c; ++b)
                    if (a[b].match(f)) return !0; return !1 },
            checkIfAnyObjectPropertyMatches: function(a, f) { for (var b in a)
                    if (b.match(f)) return !0; return !1 },
            ...
            style: {
                parse: {
                    ...
                    margin: function(a) {
                        function b(a) { c.top = k[a[0]];
                            c.right = k[a[1]];
                            c.bottom = k[a[2]];
                            c.left = k[a[3]] } var c = {},
                            k = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"]; switch (k.length) {
                            case 1:
                                b([0, 0, 0, 0]); break;
                            case 2:
                                b([0, 1, 0, 1]); break;
            ...
            array: {
                ...
                forEach: function(a, b, c) { var k = a.length,
                        d; for (d = 0; d < k; d++) b.call(c, a[d], d, a) },
                map: function(a, b, c) { for (var k = [], d = 0; d < a.length; d++) k.push(b.call(c, a[d], d, a)); return k },
                reduce: function(a, b, c, k) { for (var d = 0; d < a.length; d++) c = b.call(k, c, a[d], d, a); return c }
            },
            object: { findKey: function(a, b) { if ("object" !== typeof a) return null; for (var c in a)
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getByAddress: function(a, d) {
            for (var b =
                    ...
                    for (var g = -1, h = 0; h < b.childNodes.length; h++) { var k = b.childNodes[h]; if (!0 !== d || 3 != k.nodeType || !k.previousSibling || 3 != k.previousSibling.nodeType)
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    h && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = w ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = e.left + b - m, c = e.top + c - x) } else
                    for (x = this, m = null; x && "body" != x.getName() &&
                        ...
                        m = x;
                        x = (e = x.$.offsetParent) ? new CKEDITOR.dom.element(e) : null } a && (e = this.getWindow(), x = a.getWindow(), !e.equals(x) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function x(a, b) { var c = { x: 0, y: 0 }; if (!a.is(h ? "body" : "html")) { var f = a.$.getBoundingClientRect();
                        c.x = f.left;
                        c.y = f.top } f = a.getWindow();
                    f.equals(b) || (f = x(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y); return c }
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) { var u = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    y = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
                this._.guardRTL = function(a, b) { return (!b || !u.equals(a)) && (!y || !a.equals(y)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) } }
        ...
        CKEDITOR.dom.walker.empty = function(a) { return function(b) { for (var c = 0, f = b.getChildCount(); c < f; ++c)
                    if (!q(b.getChild(c))) return !!a; return !a } };
        var f = CKEDITOR.dom.walker.empty(),
            D = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function(a) { var b = {},
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function g(a, b, c, f) { var X = c ? a.getPrevious() : a.getNext(); if (f && h) return X;
                l || f ? b.append(a.clone(!0, e), c) : (a.remove(), q && b.append(a, c)); return X }

            function m() { var a, b, c, f = Math.min(O.length, p.length); for (a = 0; a < f; a++)
            ...
            if (l && J.type == CKEDITOR.NODE_TEXT && (r.equals(J) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(J))) c.append(a.document.createText(J.substring(H, E)));
                ...
                for (var O = r.getParents(), p = J.getParents(), C = m(),
                        t = O.length - 1, F = p.length - 1, N = c, X, Y, U, ea = -1, P = C; P <= t; P++) { Y = O[P];
                    U = Y.getNext(); for (P != t || Y.equals(p[P]) && t < F ? b && (X = N.append(Y.clone(0, e))) : u ? g(Y, N, !1, v) : L && N.append(a.document.createText(Y.substring(H))); U;) { if (U.equals(p[P])) { ea = P; break } U = g(U, N) } N = X } N = c;
                for (P = C; P <= F; P++)
                    if (c = p[P], U = c.getPrevious(), c.equals(O[P])) b && (N = N.getChild(0));
                    else { P != F || c.equals(O[P]) && F < t ? b && (X = N.append(c.clone(0, e))) : y ? g(c, N, !1, B) : n && N.append(a.document.createText(c.substring(0, E))); if (P > ea)
                            for (; U;) U = g(U, N, !0);
                        N = X } l || k()
            }
        }
        ...
        function b() { var a = !1,
                ...
                d = CKEDITOR.dom.walker.bogus(); return function(e) { return c(e) || b(e) ? !0 : d(e) && !a ? a = !0 : e.type == CKEDITOR.NODE_TEXT && (e.hasAscendant("pre") || CKEDITOR.tools.trim(e.getText()).length) || e.type == CKEDITOR.NODE_ELEMENT && !e.is(g) ? !1 : !0 } }
        ...
        function e(a) { return function() { var b; return this[a ? "getPreviousNode" : "getNextNode"](function(a) {!b && q(a) && (b = a); return n(a) && !(h(a) && a.equals(b)) }) } }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                ...
                function b(a, c) { var f = c.getCustomData("cke-fillingChar"); if (f) { var d = a.container;
                ...
                return function(c) {
                    ...
                    return { start: e.container.getAddress(c), end: d ? null : m.container.getAddress(c), startOffset: e.offset, endOffset: m.offset, normalized: c, collapsed: d, is2: !0 }
                }
            }(),
            ...
            trim: function(a, b) {
                var c = this.startContainer,
                    d = this.startOffset,
                    e = this.collapsed;
                if ((!a || e) && c && c.type == CKEDITOR.NODE_TEXT) { if (d)
                        if (d >= c.getLength()) d = c.getIndex() + 1, c = c.getParent();
                        else { var g = c.split(d),
                                d = c.getIndex() + 1,
                                c = c.getParent();
                            this.startContainer.equals(this.endContainer) ? this.setEnd(g, this.endOffset - this.startOffset) : c.equals(this.endContainer) && (this.endOffset += 1) } else d = c.getIndex(), c = c.getParent();
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var g = function(a, b) {
                            ...
                            var c = new CKEDITOR.dom.walker(c),
                                f;
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; f = c.next();) { if (f.type != CKEDITOR.NODE_TEXT) return !1;
                                u = f != a ? f.getText() : f.substring(b); if (d.test(u)) return !1 }
                            return !0
                        };
                        ...
                        E.type == CKEDITOR.NODE_TEXT ? (y && (E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E, H = !!E), E && ((r = E.getPrevious()) || (l = E.getParent()))) : (y && (r = E.getChild(y - 1) || E.getLast()),
                            r || (l = E));
                        for (l = c(l); l || r;) {
                            if (l && !r) {!J && l.equals(m) && (J = !0); if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                                        ...
                                        if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                                            ...
                                            if (d.test(u)) r = null;
                                                ...
                                                for (var y = r.$.getElementsByTagName("*"), v = 0, B; B = y[v++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { r = null; break } r && (E = !!u.length)
                                        } else r = null;
                                    E && (H ? J ? h = l : l && this.setStartBefore(l) : H = !0);
                                    if (r) { E = r.getPrevious(); if (!l && !E) { l = r;
                                            r = null; break } r = E } else l = null
                                } l && (l = c(l.getParent()))
                        }
                        E = this.endContainer;
                        y = this.endOffset;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var L, n, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            p = null,
                            C = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (p) { if (p.equals(a)) { p = null; return } } else p = a;
                                else if (p) return; var b = O(a);
                                b || (L = a); return b },
                            e = function(a) { var b = C(a);!b && a.is && a.is("br") && (n = a); return b };
                        l.guard = C;
                        l = l.lastBackward();
                        L = L || k;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
                            l = new CKEDITOR.dom.walker(l); var t = CKEDITOR.dom.walker.whitespaces(),
                                F = CKEDITOR.dom.walker.bookmark();
                            l.evaluator = function(a) { return !t(a) && !F(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone();
                        l.collapse();
            ...
            fixBlock: function(a, b) { var c = this.createBookmark(),
                ...
                d.trim();
                this.insertNode(d); var e = d.getBogus();
                e && e.remove();
                d.appendBogus();
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) { for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, g; e && !e.equals(d.root) && !e.getFirst(a(e));) g = e.getParent(), this[b ? "setEndAt" : "setStartAt"](e, CKEDITOR.POSITION_AFTER_END), e.remove(1), e = g;
            ...
            checkBoundaryOfElement: function(a, b) { var d = b == CKEDITOR.START,
                ...
                e.evaluator = c(d); return e[d ? "checkBackward" : "checkForward"]() },
            ...
            moveToElementEditablePosition: function(a, b) {
                if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1)) return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START),
                    !0;
                for (var c = 0; a;) {
                    if (a.type == CKEDITOR.NODE_TEXT) { b && this.endContainer && this.checkEndOfBlock() && k.test(a.getText()) ? this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START) : this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START);
                        c = 1; break }
                    if (a.type == CKEDITOR.NODE_ELEMENT)
    ...
    (function() {
        ...
        function b(a, c, e, g) {
            a: { null == g && (g = d(e)); for (var k; k = g.shift();)
                    if (k.getDtd().p) { g = { element: k, remaining: g }; break a } g = null }
            if (!g) return 0;
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0);
                        ...
                        var r = m.getName();
                        if (CKEDITOR.dtd.$block[r] && "false" == m.getAttribute("contenteditable")) { d = m;
                            b(this, a, d); break } else if (m.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })) { if ("br" == r) I = 1;
                            else if (!h && !m.getChildCount() && "hr" != r) { d = m;
                                w = m.equals(x); break } h && (h.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != r && (this._.nextNode = m));
                            K = 1 } else { if (m.getFirst()) { h || (h = this.range.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                                m = m.getFirst(); continue } I = 1 }
                    }
                    I && !h && (h = this.range.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                    w = (!K || I) && m.equals(x);
                    if (h && !K)
                        for (; !m.getNext(k) && !w;) { r = m.getParent(); if (r.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })) { K = 1;
                                I = 0;
                                w || r.equals(x);
                                h.setEndAt(r, CKEDITOR.POSITION_BEFORE_END); break } m = r;
                            I = 1;
                            w = m.equals(x);
                            l = 1 } I && h.setEndAt(m, CKEDITOR.POSITION_AFTER_END);
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (g in O) { u = O[g];
                    r = t[u];
                    m = [];
                    F = void 0; for (F in r) - 1 < F.indexOf("*") ? m.push(new RegExp("^" + F.replace(/\*/g, ".*") + "$")) : m.push(F);
                    r = m;
                    r.length && (t[u] = r, p = !1) } t.nothingRequired = p;
        ...
        function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
                ...
                a = a.classes;
                b = b.classes; if (a) { for (var d = !1, f = !0 === a, t = b.length; t--;)
        ...
        function h(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = B(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {},
                d = 0,
                e; for (e in a) c[e] = a[e], d++; return d ? c : !1 }
        ...
        function k(a, b) {
            ...
            if (e = a.requiredClasses)
                for (f = b.classes, c = 0; c < e.length; ++c)
                    if (d = e[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(f, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(f, d)) return !1;
        ...
        function f(a) { var b, c, d, e, f = {},
                t = 1; for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, f["$" + t++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f }

        function D(a, b) { var c = a.match(C[b]); return c ? B(c[1]) : null }
        ...
        function A(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) { a: { u = a.elementCallbacks; for (var v = 0, g = u.length, p; v < g; ++v)
                        if (p = u[v](b)) { u = p; break a } u = void 0 } if (u) return u }
            if (f.doTransform && (u = a._.transformations[b.name])) { w(b); for (v = 0; v < u.length; ++v) r(a, b, u[v]);
                x(b) }
            if (f.doFilter) {
                a: {
                    ...
                    p = f.skipRequired;
                    var y = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 },
                        B, C;
                    if (a || u) { w(b); if (v)
                            for (B = 0, C = v.length; B < C; ++B)
                                if (!1 === c(v[B], b, y)) { a = null; break a } if (g)
                            for (B = 0, C = g.length; B < C; ++B) c(g[B], b, y); if (a)
                            for (B = 0, C = a.length; B < C; ++B) d(a[B], b, y, p); if (u)
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (H in k) a.allStyles || h[H] ? E.push(H + ":" + k[H]) : B = !0;
                    E.length && (v.style = E.sort().join("; ")) } else J && (v.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (H = 0; H < g.length; ++H)(a.allClasses || u[g[H]]) && y.push(g[H]);
                    y.length && (v["class"] = y.sort().join(" "));
                    p && y.length < p.split(/\s+/).length && (B = !0) } else p && (v["class"] = p);B && (l = 1);
        ...
        function K(a) { if (!a) return !1; if (!0 === a) return !0; var b = G(a); return function(c) { return c in a || b && c.match(b) } }
        ...
        function l(a, b, c) {
            var d = a.name;
            if (y.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
        ...
        function J(a, b) {
            ...
            for (f in d)
                if ("class" == f)
                    for (c = d[f].split(/\s+/), t = a.classes.join("|"); v = c.pop();) { if (-1 == t.indexOf(v)) return !1 } else if (a.attributes[f] != d[f]) return !1;
            for (l in e)
                if (a.styles[l] !=
                    e[l]) return !1;
            return !0
        ...
        function H(a, b) { var c, d; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0], d = a[1]); return [{ element: c, left: d, right: function(a, c) { c.transform(a, b) } }] }

        function E(a) { return function(b) { return J(b, a) } }

        function u(a) { return function(b, c) { c[a](b) } }
        var y = CKEDITOR.dtd,
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))
                            ...
                            else if (v & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                        var c;
                        a: {
            ...
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        e; for (b = 0; b < a.length && !e; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b) d.push(H(a[b], e));
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        for (l = 0; l < b.length; ++l) t = b[l], "string" == typeof t ? (t = t.split(/\s*:\s*/), v = t[0], g = null, p = t[1]) : (v = t.check, g = t.left, p = t.right), f || (f = t, f = f.element ? f.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                            f.left.getDefinition().element), g instanceof CKEDITOR.style && (g = E(g)), c.push({ check: v == f ? null : v, left: g, right: "string" == typeof p ? u(p) : p });
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
        ...
        N = CKEDITOR.filter.transformationsTools = {
            ...
            lengthToAttribute: function(a, b, c) { c = c || b; if (!(c in a.attributes)) { var d = a.styles[b],
                        e = d && d.match(/^(\d+)(?:\.\d*)?px$/);
                    e ? a.attributes[c] = e[1] : "cke-test" == d && (a.attributes[c] = "cke-test") } delete a.styles[b] },
            ...
            splitBorderShorthand: function(a) {
                function b(d) { a.styles["border-top-width"] = c[d[0]];
            ...
            matchesStyle: J,
            transform: function(a, b) { if ("string" == typeof b) a.name = b;
                else { var c = b.getDefinition(),
                        d = c.styles,
                        e = c.attributes,
                        f, t, l, v;
                    a.name = c.element; for (f in e)
                        if ("class" == f)
                            for (c = a.classes.join("|"), l = e[f].split(/\s+/); v = l.pop();) - 1 == c.indexOf(v) && a.classes.push(v);
                        else a.attributes[f] = e[f]; for (t in d) a.styles[t] = d[t] } }
        }
    })();
    (function() {
            ...
            load: function(b, c, e, g) {
                ...
                if (0 === k) f(!0);
                    ...
                    var D = function(a, b) {
                        ...
                        w = function(b, c) { a[b] = 1; var e = d[b];
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + h[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)
                    for (var g = h[a[f]], n = 0; n < g.length; n++) { var m = g[n];
                        k[m] = this.get(m);
                        c[m] = 1 } d.call(b, k) }, this)
        }
    };
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (f in a) { var k = a[f],
                                w = k && k.requires; if (!d[f]) { if (k.icons)
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++G; while (CKEDITOR.instances[a]); return a }
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                CKEDITOR.scriptLoader.load(f, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++)
                        for (var l =
                                0; l < d.length; l++) { var v = d[l];
                            0 === f && e[l] && v.lang && v.langEntries && (a.lang[v.name] = v.langEntries[e[l]]); if (v[c[f]]) v[c[f]](a) } a.fireOnce("pluginsLoaded");
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function() {
                ...
                function b(a) { return !!(a && a.call && a.apply) } var c = this,
                    d = c.element,
            ...
            extractSelectedHtml: function(a, b) { var c = this.editable(),
                    ...
                    f; if (!c || 0 === d.length) return null; for (f = 0; f < d.length; f++) e.append(c.extractHtmlFromRange(d[f], b));
                b || this.getSelection().selectRanges([d[0]]); return a ? e.getHtml() : e },
            ...
            setActiveEnterMode: function(a,
                b) { a = a ? this.blockless ? CKEDITOR.ENTER_BR : a : this.enterMode;
                ...
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (e = c[1])
                        if (e = e.toLowerCase(), h && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(h.join("")), h = null), !h) { this.onTagClose(e); continue } if (h) h.push(c[0]);
                                ...
                                n, q = c[4];
                            c = !!c[5]; if (q)
                                for (; n = a.exec(q);) { var f = n[1].toLowerCase();
                                    n = n[2] || n[3] || n[4] || "";
                                    k[f] = !n && d[f] ? f : CKEDITOR.tools.htmlDecodeAttr(n) } this.onTagOpen(e, k, c);!h && CKEDITOR.dtd.$cdata[e] && (h = []) } } else if (e = c[2]) this.onComment(e)
                }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, h, k) {
                ...
                function q() { for (; K.length;) D(K.shift(), z) }
                ...
                function D(b, c, d) { c = c || z || x; var e = z;
                ...
                G.onTagOpen = function(e, f, g, k) {
                    ...
                    if (a(f)) m.push(f);
                        ...
                        if ("pre" == e) l = !0;
                        else { if ("br" == e && l) { z.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (I = !0) }
                        if ("br" == e) K.push(f);
                        else {
                ...
                G.onTagClose = function(a) {
                    for (var b = m.length - 1; 0 <= b; b--)
                        if (a == m[b].name) { m.splice(b, 1); return } for (var c = [], d = [], e = z; e != x && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
                    if (e != x) {
                        for (b = 0; b < c.length; b++) { var f = c[b];
                            D(f, f.parent) } z =
                            e;
                        e._.isBlockLike && q();
                        D(e, e.parent);
                ...
                G.onText = function(a) { if (!(z._.hasInlineStarted && !K.length || l || I) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = z.name,
                        f = b ? CKEDITOR.dtd[b] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!I && !f["#"] && b in d) G.onTagOpen(e[b] || ""), G.onText(a);
                    else { q();
                        n();
                        l || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (w(z, a)) this.onTagOpen(k, {}, 0, 1);
                        z.add(a) } };
                G.onCDATA =
                    function(a) { z.add(new CKEDITOR.htmlParser.cdata(a)) };
                G.onComment = function(a) { q();
                    n();
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) { for (var g = [this.findIndex(c), 0], h = 0, k = a.length; h < k; h++) g.push({ value: a[h], priority: c, options: d });
            ...
            exec: function(a, c) {
                ...
                for (D = 0; D < k; D++)
                    if (d && (n = c.type, q = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
                            a.nestedEditable && f.options.excludeNestedEditable)) { f = f.value.apply(null, g); if (!1 === f || d && f && (f.name != q || f.type != n)) return f;
    ...
    (function() {
        ...
        function D(a) { return a.replace(V, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function G(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function(a, b) { return c && c[b] || "" }) }
        ...
        function x(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, e) { return "\x3c" + c + d + "\x3e" + G(A(e), b) + "\x3c/" + c + "\x3e" })
        }
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            ...
            toDataFormat: function(a, b) { var c, d, e;
                b && (c = b.context, d = b.filter, e = b.enterMode);
                c || null === c || (c = this.editor.editable().getName()); return this.editor.fire("toDataFormat", { dataValue: a, filter: d || this.editor.filter, context: c, enterMode: e || this.editor.enterMode }).dataValue }
        };
        var m = /(?:&nbsp;|\xa0)$/,
            K = "{cke_protected}",
            z = CKEDITOR.dtd,
            ...
            E = {
                ...
                elements: {
                    ...
                    table: function(a) { a.children.slice(0).sort(function(a, b) { var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(I, a.name), d = CKEDITOR.tools.indexOf(I, b.name)); - 1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1); return c > d ? 1 : -1 }) },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) { h = d.name; if (!(k = a.onElementName(b, h))) return this.remove(), !1;
                    d.name = k; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == h) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 } h = d.attributes;
                var n, q;
                for (n in h) {
                    for (k = h[n];;)
            ...
            writeHtml: function(a, b) { b && this.filter(b); var g = this.name,
                    ...
                    k = this.attributes,
                    n, q;
                a.openTag(g, k); for (n in k) h.push([n, k[n]]);
                a.sortAttributes && h.sort(d);
                n = 0; for (q = h.length; n < q; n++) k = h[n], a.attribute(k[0], k[1]);
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) { var k = d.checkDirty(),
                    ...
                    d._.previousModeData = n = d.getData(1); "source" == d.mode && h == n && (d.fire("lockSnapshot", { forceUpdate: !0 }), q = 1);
    ...
    (function() {
        function a(a) {
            ...
            h(b, e.block, f) && u.collapsed && !u.getCommonAncestor().isReadOnly() && (e = u.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        function g(a) {
            ...
            if (e.startPath().contains(f)) { var u = e.clone();
                u.collapse(1);
                u.setStartAt(a, CKEDITOR.POSITION_AFTER_START);
                a = new CKEDITOR.dom.walker(u);
                a.guard = b();
                a.checkBackward(); if (d) return u = e.clone(), u.collapse(), u.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(u), a.guard = b(!0), d = !1, a.checkForward(), d }
            return null
        }
        ...
        function q(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) e = !0;
                            else { if (CKEDITOR.env.webkit && (e = c.getDocument().getActive()) && e.equals(c) && !d.anchorNode) { e = !0; break a } e = void 0 } e && (e = new CKEDITOR.dom.range(c), e.moveToElementEditStart(c), b = b.createRange(), b.setStart(e.startContainer.$, e.startOffset), b.collapse(!0), d.removeAllRanges(),
                            d.addRange(b))
                    }
                ...
                getHtmlFromRange: function(a) { if (a.collapsed) return new CKEDITOR.dom.documentFragment(a.document);
                    ...
                    z.eol.fix(a, this); return new CKEDITOR.dom.documentFragment(a.fragment.$) },
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                    ...
                                    g; if (d)
                                    for (; g = d.getItem(f++);)
                                        if (!D(g)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), w(a.startContainer) && a.startContainer.appendBogus();
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() { var b = this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(G, function(a, b) { return b }));
                    ...
                    if (!this.is("textarea")) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) { b.data.getKeystroke() in y && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
        ...
        x = function() {
            ...
            return function(B, p, C, t) {
                ...
                if (!t.checkReadOnly()) {
                    ...
                    B = { type: p, dontFilter: N, editable: B, editor: F, range: t, blockLimit: q, mergeCandidates: [], zombies: [] };
                    p = B.range;
                    t = B.mergeCandidates;
                    var m, w;
                    ...
                    if (!p.collapsed) { var F = q.block || q.blockLimit,
                    ...
                    if (m = C) {
                        m = B.range;
                        if ("text" == B.type && B.inlineStylesRoot) { w = B.inlineStylesPeak;
                            p = w.getDocument().createText("{cke-peak}"); for (t = B.inlineStylesRoot.getParent(); !w.equals(t);) p = p.appendTo(w.clone()), w = w.getParent();
                            C = p.getOuterHtml().split("{cke-peak}").join(C) } w =
                            B.blockLimit.getName();
                        if (/^\s+|\s+$/.test(C) && "span" in CKEDITOR.dtd[w]) { var D = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            C = D + C + D } C = B.editor.dataProcessor.toHtml(C, { context: null, fixForBody: !1, protectedWhitespaces: !!D, dontFilter: B.dontFilter, filter: B.editor.activeFilter, enterMode: B.editor.activeEnterMode });
                        ...
                        if ((D = m.startPath().block) && (1 != D.getChildCount() || !D.getBogus())) a: {
                            var A;
                            if (1 ==
                                w.getChildCount() && a(A = w.getFirst()) && A.is(L) && !A.hasAttribute("contenteditable")) { D = A.getElementsByTag("*");
                                m = 0; for (t = D.count(); m < t; m++)
                    ...
                    if (m) {
                        ...
                        for (g(p, A); t < p.length; t++) {
                            q = p[t];
                            if (M = q.isLineBreak) { M = A;
                                I = w; var R = void 0,
                                    Z = void 0;
                                q.hasBlockSibling ? M = 1 : (R = M.startContainer.getAscendant(v.$block, 1)) && R.is({ div: 1, p: 1 }) ? (Z = R.getPosition(I), Z == CKEDITOR.POSITION_IDENTICAL || Z == CKEDITOR.POSITION_CONTAINS ? M = 0 : (I = M.splitElement(R), M.moveToPosition(I, CKEDITOR.POSITION_AFTER_START), M = 1)) : M = 0 }
                            if (M) C = 0 < t;
                            else {
                                M = A.startPath();
                                ...
                                if ((M = A.startPath().block) && !M.equals(G)) { if (z = M.getBogus()) z.remove(), D.push(M);
                                    G = M } q.firstNotAllowed && (F = 1);
                                if (F && q.isElement) {
                                    M = A.startContainer;
                                    for (I = null; M && !v[M.getName()][q.name];) { if (M.equals(w)) { M = null; break } I = M;
                                        M = M.getParent() }
                                ...
                                if (W) { for (; M = W.pop();) A.insertNode(M);
                                    W = 0 } else A.insertNode(q.node);
                    ...
                    if (!B.dontMoveCaret) {
                        for (G = e(z); G && a(G) && !G.is(v.$empty);) {
                            ...
                            else { if (f(G) && G.getHtml().match(/(\s|&nbsp;)$/g)) { Q = null; break } Q = z.clone();
                                Q.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END) } G = G.getLast(c)
                        }
                        Q && z.moveToRange(Q)
                    }
                }
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({
                        ...
                        g = function(a) { return !a.equals(v) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) { var k = e.contains(CKEDITOR.dtd.$list).getParent();
                        g = function(a) { return !a.equals(k) } } g || (g = function(a) { return !a.equals(e.block) && !a.equals(e.blockLimit) });
            ...
            return {
                list: {
                    ...
                    merge: function(a, c) { if (a.mergeListBookmark) { var d = a.mergeListBookmark.startNode,
                                ...
                                g = new CKEDITOR.dom.elementPath(e, c); if (a.mergeList) { var k = f.contains(CKEDITOR.dtd.$list),
                                    h = g.contains(CKEDITOR.dtd.$list);
                                k.equals(h) || (h.moveChildren(k), h.remove()) } a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), g = g.contains(CKEDITOR.dtd.$listItem), f.equals(g) || b(g, d, e));
                            d.remove();
                            e.remove() } }
                },
                block: {
                ...
                table: function() {
                    function a(c) {
                        ...
                        g.guard = function(a, g) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) { var F = "visited_" + (g ? "out" : "in"); if (a.getCustomData(F)) return;
                    ...
                    return {
                        ...
                        deleteRanges: function(a) { for (var b; b = a.tableContentsRanges.pop();) b.extractContents(), w(b.startContainer) && b.startContainer.appendBogus();
    ...
    (function() {
        function a(a, b) { if (0 === a.length) return !1; var c, d; if ((c = !b && 1 === a.length) && !(c = a[0].collapsed)) { var e = a[0];
                c = e.startContainer.getAscendant({ td: 1, th: 1 }, !0); var f = e.endContainer.getAscendant({ td: 1, th: 1 }, !0);
                d = CKEDITOR.tools.trim;
                c && c.equals(f) && !c.findOne("td, th, tr, tbody, table") ? (e = e.cloneContents(), c = e.getFirst() ? d(e.getFirst().getText()) !== d(c.getText()) : !0) : c = !1 } if (c) return !1; for (d = 0; d < a.length; d++)
                if (c = a[d]._getTableElement(), !c) return !1; return !0 }
        ...
        function b(a) { a = d(a); var b = "",
                c = [],
                e, f; for (f = 0; f < a.length; f++) e && !e.equals(a[f].getAscendant("tr")) ? (b += c.join("\t") + "\n", e = a[f].getAscendant("tr"), c = []) : 0 === f && (e = a[f].getAscendant("tr")), c.push(a[f].getText()); return b += c.join("\t") }
        ...
        function n(a) {
            function b(c, d) { return c && c.type != CKEDITOR.NODE_TEXT ? a.clone()["moveToElementEdit" + (d ? "End" : "Start")](c) : !1 } if (!(a.root instanceof CKEDITOR.editable)) return !1; var c = a.startContainer,
                d = a.getPreviousNode(k, null, c),
                e = a.getNextNode(k, null, c); return b(d) || b(e, 1) || !(d || e || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() && c.getBogus()) ? !0 : !1 }
        ...
        function f(a, b) {
            ...
            if (c) {
                if (!1 !== b) { var d = a.getDocument().getSelection().getNative(),
                        e = d && "None" != d.type && d.getRangeAt(0),
                        f = K.length; if (c.getLength() > f && e && e.intersectsNode(c.$)) { var g = [{ node: d.anchorNode, offset: d.anchorOffset }, { node: d.focusNode, offset: d.focusOffset }];
                        d.anchorNode == c.$ && d.anchorOffset > f && (g[0].offset -= f);
                        d.focusNode == c.$ && d.focusOffset > f && (g[1].offset -= f) } } c.setText(D(c.getText(), 1));
        ...
        function D(a, b) { return b ? a.replace(z, function(a, b) { return b ? " " : "" }) : a.replace(K, "") }
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                function a() { q = new CKEDITOR.dom.selection(c.getSelection());
                    q.lock() }
                ...
                var k = c.document,
                    ...
                    l = h.isInline(),
                    y, q;
                CKEDITOR.env.gecko && h.attachListener(h, "focus", function(a) { a.removeListener();
                    0 !== y && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == h.$ && (a = c.createRange(), a.moveToElementEditStart(h), a.select()) }, null, null, -2);
                ...
                h.attachListener(h, "mousedown", function() { y = 0 });
                if (CKEDITOR.env.ie || l) x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { c.lockSelection(q);
                    y = 1 }, null, null, -1), h.attachListener(h, "mousedown", function() { y = 0 });
                if (CKEDITOR.env.ie && !l) {
                    ...
                    h.attachListener(h, "mouseup", function(a) { 2 == a.data.$.button && n && (c.document.$.documentElement.scrollLeft = n.x, c.document.$.documentElement.scrollTop = n.y);
                        n = null });
                    if ("BackCompat" != k.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            u.on("mousedown", function(a) {
                                ...
                                function c() { u.removeListener("mousemove", b);
                                    p.removeListener("mouseup", c);
                                    u.removeListener("mouseup", c);
                                    m.select() } a = a.data;
                                if (a.getTarget().is("html") && a.$.y < u.$.clientHeight && a.$.x < u.$.clientWidth) { m = t.$.createTextRange(); try { m.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {} w = m.duplicate();
                                    u.on("mousemove", b);
                                    p.on("mouseup", c);
                                    u.on("mouseup", c) }
                            })
                ...
                h.attachListener(h, "keydown", function(a) { var b = this.getSelection(1);
                ...
                if (l && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    var r;
                    h.attachListener(h, "mousedown", function() { r = 1 });
                    h.attachListener(k.getDocumentElement(),
                        "mouseup",
                        function() { r && g.call(c);
                            r = 0 })
                } else h.attachListener(CKEDITOR.env.ie ? h : k.getDocumentElement(), "mouseup", g, c);
                CKEDITOR.env.webkit && h.attachListener(k, "keydown", function(a) { switch (a.data.getKey()) {
                        case 13:
                        case 33:
                        case 34:
                        case 35:
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
            ...
            b.on("selectionChange", function() { var a = b.editable(),
                ...
                c && (c.getCustomData("ready") ? (f(a), a.editor.fire("selectionCheck")) : c.setCustomData("ready", 1)) }, null, null, -1);
            b.on("beforeSetMode", function() { f(b.editable()) }, null, null, -1);
            b.on("getSnapshot", function(a) { a.data && (a.data = D(a.data)) },
                b, null, 20);
            b.on("toDataFormat", function(a) { a.data.dataValue = D(a.data.dataValue) }, null, null, 0)
        });
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (a)
                ...
                else { try { e = a.createRange() } catch (f) {} d = e && CKEDITOR.dom.element.get(e.item && e.item(0) || e.parentElement()) } if (!d || d.type != CKEDITOR.NODE_ELEMENT && d.type != CKEDITOR.NODE_TEXT || !this.root.equals(d) && !this.root.contains(d)) this._.cache.type = CKEDITOR.SELECTION_NONE, this._.cache.startElement = null, this._.cache.selectedElement =
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: D, _createFillingCharSequenceNode: q, FILLING_CHAR_SEQUENCE: K });
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: x ? function() { var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_NONE; try { var c = this.getNative(),
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) },
                        function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && E[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
            ...
            getSelectedText: function() { var a = this._.cache; if (void 0 !== a.selectedText) return a.selectedText; var b = this.getNative(),
                    b = x ? "Control" == b.type ? "" : b.createRange().text : b.toString(); return a.selectedText = b },
            lock: function() {
                this.getRanges();
            ...
            unlock: function(b) { if (this.isLocked) { if (b) var d = this.getSelectedElement(),
                        e = this.getRanges(),
                        f = this.isFake;
                    this.isLocked = 0;
                    this.reset();
                    ...
                    if (this.isLocked) { var k = CKEDITOR.document.getActive();
                        ...
                        if (l) this.fake(l);
                            ...
                            if (x) {
                                ...
                                b = d.collapsed;
                                var t, F, m;
                                if ((e = d.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName() in E && (!e.is("a") || !e.getText())) try { m = e.$.createControlRange();
                                    m.addElement(e.$);
                                    m.select(); return } catch (w) {}
                                ...
                                for (m = 0; m < b.length; m++) {
                                    if (m <
                                        b.length - 1 && (t = b[m], F = b[m + 1], l = t.clone(), l.setStart(t.endContainer, t.endOffset), l.setEnd(F.startContainer, F.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), d = l.getCommonAncestor(), l = l.getEnclosedNode(), d.isReadOnly() || l && l.isReadOnly()))) { F.setStart(t.startContainer, t.startOffset);
                                        b.splice(m--, 1); continue } d = b[m];
                                    ...
                                    try { F.setEnd(d.endContainer.$, d.endOffset) } catch (r) { if (0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), F.setEnd(d.endContainer.$, d.endOffset);
                                        else throw r; } k.addRange(F)
                                }
                            }
                            this.reset();
                            this.root.fire("selectionchange")
            ...
            selectBookmarks: function(b) {
                for (var c = [], d, e = 0; e < b.length; e++) { var f = new CKEDITOR.dom.range(this.root);
                    f.moveToBookmark(b[e]);
                    c.push(f) } b.isFake && (d = a(c) ? c[0]._getTableElement() : c[0].getEnclosedNode(), d && d.type ==
    ...
    (function() {
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0;
                        ...
                        if (x && m && CKEDITOR.dtd.$block[A])
                            for (var z = r, y = e(z), E = void 0, H = y.length, I = 0, z = H && new CKEDITOR.dom.range(z.getDocument()); I < H; ++I) { var E = y[I],
                                    J = CKEDITOR.filter.instances[E.data("cke-filter")]; if (J ? J.check(this) : 1) z.selectNodeContents(E), b.call(this, z) } y = A ? !q[A] || D ? 0 : x && !m ? 0 : d(r, u, h, V) : 1;
                        if (y)
                            if (E = r.getParent(), y = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E)) l = !0;
                            else {
                                if (v ||
                                    A && CKEDITOR.dtd.$removeEmpty[A] && (r.getPosition(u) | V) != V || (v = c.clone(), v.setStartBefore(r)), A = r.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) { for (var A = r, L;
        ...
        function c(a) {
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(q.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break;
                    n.checkElementRemovable(h, !0) && (e = h) } for (g = 0; g < c.elements.length; g++) { h = c.elements[g]; if (h == c.block || h == c.blockLimit) break;
                    n.checkElementRemovable(h, !0) && (f = h) } f && q.breakParent(f);
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
                    if (this.checkElementRemovable(k)) { var m;!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = m ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? A.call(this, k) : x(k, l(this)[k.getName()])) } if (g) {
                    e = d;
                    for (h =
            ...
            } else { var q = c.endNode,
                    n = this;
                b(); for (f = d; !f.equals(q);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g } a.moveToBookmark(c);
        ...
        function k(a) { var b = a.createBookmark(!0),
            ...
            this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = K(this, e, d), q(d, f));
            a.moveToBookmark(b) }
        ...
        function w(a, b) {
            ...
            for (var d = 0; d < a.length; d++) {
                var e = a[d],
                    ...
                    e = D(e, /^[ \t]*\n/, ""),
                    e = D(e, /\n$/, ""),
                    e = D(e, /^[ \t]+|[ \t]+$/g, function(a, b) { return 1 == a.length ? "\x26nbsp;" : b ? " " + CKEDITOR.tools.repeat("\x26nbsp;", a.length - 1) : CKEDITOR.tools.repeat("\x26nbsp;", a.length - 1) + " " }),
                    e = e.replace(/\n/g, "\x3cbr\x3e"),
        ...
        function G(a) { for (var b = l(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0); for (var f in b)
                if (f != this.element)
        ...
        function m(a, b) {
            if (!a.hasAttributes() || b)
                if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(L),
                        d = a.getNext(L);!c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1);!d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br");
        ...
        function z(a, b) { var c = b._.definition,
                d = c.attributes,
        ...
        var E = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            u = {
                a: 1,
                blockquote: 1,
                embed: 1,
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return H.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
            ...
            applyToObject: function(a) { z(a, this) },
                ...
                if ("string" == typeof this.element ?
                    d == this.element : d in this.element) { if (!b && !a.hasAttributes()) return !0; if (d = c._AC) c = d;
                        ...
                        c = c._AC = d } if (c._length) { for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? J(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0 }
                return !1
            },
        ...
        CKEDITOR.style.getStyleText = function(a) { var b = a._ST; if (b) return b; var b = a.styles,
                ...
                d = "";
            c.length && (c = c.replace(y, ";")); for (var e in b) { var f = b[e],
                    g = (e + ":" + f).replace(y, ";"); "inherit" == f ? d += g : c += g } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0)); return a._ST = c + d };
    ...
    CKEDITOR.dom.elementPath.prototype = {
        ...
        contains: function(a, d, b) {
            var c = 0,
                e;
            "string" == typeof a && (e = function(b) { return b.getName() == a });
            a instanceof CKEDITOR.dom.element ? e = function(b) { return b.equals(a) } : CKEDITOR.tools.isArray(a) ? e = function(b) { return -1 < CKEDITOR.tools.indexOf(a, b.getName()) } : "function" == typeof a ? e = a : "object" == typeof a && (e = function(b) {
                return b.getName() in
                    a
            });
            var g = this.elements,
    ...
    */
    ...
    CKEDITOR.plugins.add("notification", {
        init: function(b) {
            function a(b) { var a = new CKEDITOR.dom.element("div");
                ...
                setTimeout(function() { a.remove() }, 100) } b._.notificationArea = new Area(b);
    ...
    function Notification(b, a) { CKEDITOR.tools.extend(this, a, { editor: b, id: "cke-" + CKEDITOR.tools.getUniqueId(), area: b._.notificationArea });
    ...
    Notification.prototype = {
        ...
        _createElement: function() {
            ...
            a.append(c);
            c.on("click", function() { b.editor.focus();
                b.hide() });
            return a
        },
    ...
    Area.prototype = {
        add: function(b) { this.notifications.push(b);
            ...
            this._layout() },
        remove: function(b) { var a = CKEDITOR.tools.indexOf(this.notifications, b);
        ...
        _attachListeners: function() { var b = CKEDITOR.document.getWindow(),
                a = this.editor;
        ...
        _layout: function() {
            function b() { a.setStyle("left", k(n + d.width - g - h)) }
            var a = this.element,
                c = this.editor,
            ...
            f && f.isVisible() && l.bottom > d.top && l.bottom < d.bottom - r.height ? a.setStyles({
                position: "fixed",
                top: k(l.bottom)
            }) : 0 < d.top ? a.setStyles({ position: "absolute", top: k(e.y) }) : e.y + d.height - r.height > p.y ? a.setStyles({ position: "fixed", top: 0 }) : a.setStyles({ position: "absolute", top: k(e.y + d.height - r.height) });
    ...
    (function() {
        ...
        function y(b) {
            ...
            function c(a) { return { type: a, canUndo: "cut" == a, startDisabled: !0, fakeKeystroke: "cut" == a ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function() { "cut" == this.type && h(); var a; var c = this.type; if (CKEDITOR.env.ie) a = e(c);
                        else try { a = b.document.$.execCommand(c, !1, null) } catch (d) { a = !1 } a || b.showNotification(b.lang.clipboard[this.type + "Error"]); return a } } }
            ...
            function d() {
                return {
                    ...
                    fakeKeystroke: CKEDITOR.CTRL +
                        86,
                    exec: function(b, a) {
                        function c(a, g) { g = "undefined" !== typeof g ? g : !0;
                            ...
                            b.fire("afterCommandExec", { name: "paste", command: e, returnValue: !!a }) } a = "undefined" !== typeof a && null !== a ? a : {};
                        var e = this,
            ...
            function v() { if ("paste" == m.mainPasteEvent) return b.fire("beforePaste", { type: "auto", method: "paste" }), !1;
                b.focus();
                f(); var a = b.focusManager;
                a.lock(); if (b.editable().fire(m.mainPasteEvent) && !e("paste")) return a.unlock(), !1;
                a.unlock(); return !0 }
            ...
            function t(a) { var c = { type: "auto", method: "paste", dataTransfer: m.initPasteDataTransfer(a) };
                c.dataTransfer.cacheData(); var e = !1 !== b.fire("beforePaste", c);
                e && m.canClipboardApiBeTrusted(c.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function() { q(b, c) }, 0)) : k(a, function(a) { c.dataValue = a.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/ig, "");
                    e && q(b, c) }) }
            ...
            function p(a) { if (w && a in { paste: 1, cut: 1 }) return CKEDITOR.TRISTATE_DISABLED; if ("paste" == a) return CKEDITOR.TRISTATE_OFF;
            ...
            (function() {
                function a(c, e, d, g, h) { var l = b.lang.clipboard[e];
                    b.addCommand(e, d);
                    b.ui.addButton && b.ui.addButton(c, { label: l, command: e, toolbar: "clipboard," + g });
                    b.addMenuItems && b.addMenuItem(e, { label: l, command: e, group: "clipboard", order: h }) } a("Cut", "cut", c("cut"), 10, 1);
                a("Copy", "copy", c("copy"), 20, 4);
                a("Paste", "paste", d(), 30, 8) })();
            b.getClipboardData =
                function(a, c) {
                    function e(b) { b.removeListener();
                        b.cancel();
                        c(b.data) } c || (c = a, a = null);
                    b.on("paste", e, null, null, 0);!1 === v() && (b.removeListener("paste", e), c(null)) }
        }
        ...
        function D(b) { b.data.preventDefault();
        ...
        function E(b) {
            ...
            b.on("contentDom", function() {
                ...
                function f(a, c, e) { var g = { $: a.data.$, target: a.data.getTarget() };
                    c && (g.dragRange = c);
                ...
                e.attachListener(h, "drop", function(c) { if (!c.data.$.defaultPrevented) { c.data.preventDefault(); var e = c.data.getTarget(); if (!e.isReadOnly() || e.type == CKEDITOR.NODE_ELEMENT && e.is("html")) { var e = a.getRangeAtDropPosition(c, b),
                                g = a.dragRange;
                            e && f(c, g, e) } } }, null, null, 9999);
            ...
            init: function(b) {
                ...
                if (CKEDITOR.env.gecko) {
                    var d = ["image/png", "image/jpeg", "image/gif"],
                        f;
                    b.on("paste", function(a) { var c = a.data,
                                h = c.dataTransfer; if (!c.dataValue && "paste" == c.method && h && 1 == h.getFilesCount() && f != h.id && (h = h.getFile(0), -1 != CKEDITOR.tools.indexOf(d, h.type))) { var k = new FileReader;
                                k.addEventListener("load", function() { a.data.dataValue = '\x3cimg src\x3d"' + k.result + '" /\x3e';
                ...
                b.on("paste", function(a) { a.data.dataTransfer || (a.data.dataTransfer = new CKEDITOR.plugins.clipboard.dataTransfer); if (!a.data.dataValue) { var c = a.data.dataTransfer,
                            d = c.getData("text/html"); if (d) a.data.dataValue = d, a.data.type = "html";
                        else if (d = c.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(d), a.data.type = "text" } }, null, null, 1);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            isDropRangeAffectedByDragRange: function(b, a) { var c = a.startContainer,
                    d = a.endOffset; return b.endContainer.equals(c) && b.endOffset <= d || b.startContainer.getParent().equals(c) && b.startContainer.getIndex() < d || b.endContainer.getParent().equals(c) && b.endContainer.getIndex() < d ? !0 : !1 },
            ...
            getRangeAtDropPosition: function(b,
                ...
                if (document.caretRangeFromPoint && a.document.$.caretRangeFromPoint(d, f)) c = a.document.$.caretRangeFromPoint(d, f), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), e.collapse(!0);
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            for (var h = !1, k = 0; 20 > k && !h; k++) { if (!h) try { c.moveToPoint(d, f - k), h = !0 } catch (n) {}
                                if (!h) try { c.moveToPoint(d, f + k), h = !0 } catch (l) {} }
                            if (h) { var t = "cke-temp-" + (new Date).getTime();
                                c.pasteHTML('\x3cspan id\x3d"' + t + '"\x3e​\x3c/span\x3e'); var r = a.document.getById(t);
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            ...
            cacheData: function() {
                function b(b) { b = a._.normalizeType(b); var c = a.getData(b, !0);
                    c && (a._.data[b] = c) }
                if (this.$) {
                    var a = this,
                        c, d;
                    ...
                    if (this.$ && this.$.files || d) { this._.files = []; if (this.$.files && this.$.files.length)
            ...
            isEmpty: function() { var b = {},
                    a; if (this.getFilesCount()) return !1; for (a in this._.data) b[a] = 1; if (this.$)
                    if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) { if (this.$.types)
                            for (var c = 0; c < this.$.types.length; c++) b[this.$.types[c]] = 1 } else b.Text = 1, b.URL = 1; "Text" != n && (b[n] = 0); for (a in b)
                    if (b[a] && "" !== this.getData(a)) return !1; return !0 },
                ...
                _: {
                    ...
                    markFirstDisplayed: function(a) { for (var b = function(a) { return a.type == CKEDITOR.NODE_ELEMENT && "none" == a.getStyle("display") }, e = this._.getItems(), d, c, f = e.count() - 1; 0 <= f; f--)
                            if (d = e.getItem(f), d.getAscendant(b) || (c = d, this._.focusIndex = f), "true" == d.getAttribute("aria-selected")) { c = d;
                                this._.focusIndex = f; break } c && (a && a(), CKEDITOR.env.webkit && c.getDocument().getWindow().focus(), c.focus(), this.onMark && this.onMark(c)) },
                            ...
                            case "next":
                                for (var d = this._.focusIndex, e = this.element.getElementsByTag("a"), c; c = e.getItem(++d);)
                                    if (c.getAttribute("_cke_focus") && c.$.offsetWidth) { this._.focusIndex = d;
                                        c.focus(); break } return c || b ? !1 : (this._.focusIndex = -1, this.onKeyDown(a,
                                    1));
                            case "prev":
                                d = this._.focusIndex;
    ...
    (function() {
        function w(d) {
            function f(b) {
                ...
                for (a = 0; a < g.length; a++)
                    if (g[a].getName && p[g[a].getName()]) { b = g[a]; break } for (var g = l.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1], k = CKEDITOR.plugins.list.listToArray(b, q), h = k[e.getCustomData("listarray_index")].indent,
                        a = a.getCustomData("listarray_index"); a <= e.getCustomData("listarray_index"); a++)
                    if (k[a].indent += g, 0 < g) { var n = k[a].parent;
                        k[a].parent = new CKEDITOR.dom.element(n.getName(), n.getDocument()) } for (a = e.getCustomData("listarray_index") + 1; a < k.length && k[a].indent > h; a++) k[a].indent += g;
                ...
                if (r && r.length)
                    for (a = 0; a < r.length; a++) { for (m = b = r[a];
                        ...
                        b.insertAfter(f) } e && d.fire("contentDomInvalidated");
                return !0
            }
            for (var l = this, q = this.database, p = this.context, c, n = d.getSelection(), n = (n && n.getRanges()).createIterator(); c = n.getNextRange();) {
                ...
                if (!b) { var h = c.getEnclosedNode();
                    h && h.type == CKEDITOR.NODE_ELEMENT && h.getName() in p && (c.setStartAt(h, CKEDITOR.POSITION_AFTER_START), c.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), b = h) } b && c.startContainer.type == CKEDITOR.NODE_ELEMENT && c.startContainer.getName() in p && (h = new CKEDITOR.dom.walker(c), h.evaluator = t, c.startContainer = h.next());
            ...
            init: function(d) {
                function f(d) {
                    ...
                    this.jobs[this.isIndent ? 10 : 30] = {
                        refresh: this.isIndent ? function(d, c) { var f = this.getContext(c),
                                b = CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, f); return f && this.isIndent && !b ? v : u } : function(d, c) { return !this.getContext(c) || this.isIndent ? u : v },
        ...
        CKEDITOR.plugins.indentList.firstItemInPath = function(d, f, l) { var q = f.contains(t);
            l || (l = f.contains(d)); return l && q && q.equals(l.getFirst(t)) }
    })();
    (function() {
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("pastetext", { requires: "clipboard", init: function(a) { var b = CKEDITOR.env.safari ? CKEDITOR.CTRL + CKEDITOR.ALT + CKEDITOR.SHIFT + 86 : CKEDITOR.CTRL + CKEDITOR.SHIFT + 86;
                ...
                a.ui.addButton && a.ui.addButton("PasteText", { label: a.lang.pastetext.button, command: "pastetext", toolbar: "clipboard,40" }); if (a.config.forcePasteAsPlainText) a.on("beforePaste", function(a) { "html" != a.data.type && (a.data.type = "text") });
                a.on("pasteState", function(b) { a.getCommand("pastetext").setState(b.data) }) } })
    })();
    (function() {
        function l(a, c, f) { var d = CKEDITOR.cleanWord;
            d ? f() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || c + "filter/default.js"), CKEDITOR.scriptLoader.load(a, f, null, !0)); return !d } CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard",
            init: function(a) {
                var c = 0,
                    f = this.path;
                a.addCommand("pastefromword", { canUndo: !1, async: !0, exec: function(a, b) { c = 1;
                ...
                a.on("paste", function(d) {
                    ...
                    if (g && (c || h) && (!1 !== a.fire("pasteFromWord", e) || c)) {
                        b.dontFilter = !0;
                        var k =
                            l(a, f, function() { if (k) a.fire("paste", b);
            ...
            var c = CKEDITOR.plugins.scayt,
                ...
                g = function() {
                    ...
                    c.attachListener(c, "mousedown", function(b) {
                        ...
                        d && (d.wrapper = b.getAscendant(function(a) { return a.hasAttribute("data-cke-widget-wrapper") },
                            !0))
                    }, this, null, -10)
                };
            a.on("contentDom", g);
    ...
    CKEDITOR.plugins.scayt = {
        ...
        createScayt: function(a) {
            ...
            this.loadScaytLibrary(a, function(a) {
                ...
                if (f) {
                    ...
                    var g;
                    try { g = e(f) } catch (h) { c.alarmCompatibilityMessage(), delete f.charsToObserve, g = e(f) } g.subscribe("suggestionListSend", function(a) {
        ...
        loadScaytLibrary: function(a, c) { var d, b = function() { CKEDITOR.fireOnce("scaytReady");
    ...
    CKEDITOR.on("dialogDefinition", function(a) {
        ...
        if ("replace" === c) a.on("hide", function(a) { a = a.sender && a.sender.getParentEditor(); var b = CKEDITOR.plugins.scayt,
                c = a.scayt;
    ...
    (function() {
        ...
        function v(d, f) { for (var b = d.getParent().$.cells, c = 0, e = 0; e < b.length; e++) { var a = b[e],
                    c = c + (f ? 1 : a.colSpan); if (a == d.$) break } return c - 1 }

        function w(d, f) { for (var b = f ? Infinity : 0, c = 0; c < d.length; c++) { var e = v(d[c], f); if (f ? e < b : e > b) b = e } return b }
        ...
        function z(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                ...
                a: {
                    ...
                    for (a = 0; k = b[a++];)
                        if ((h = k.getPrevious()) &&
                            !h.getCustomData("delete_cell") || (h = k.getNext()) && !h.getCustomData("delete_cell")) { CKEDITOR.dom.element.clearAllMarkers(g);
                            e = h; break a } CKEDITOR.dom.element.clearAllMarkers(g);a = b[0].getParent();
        ...
        function p(d, f) { var b = d.getDocument(),
                c = CKEDITOR.document;
        ...
        function x(d, f, b) {
            ...
            if (f) { var n; try { var p = parseInt(d.getAttribute("rowspan"), 10) || 1;
                ...
                c["up" == f || "left" == f ? "unshift" : "push"](new CKEDITOR.dom.element(n)) } f =
                d.getDocument();
            var r = l,
                p = n = 0,
        ...
        function C(d, f) {
            ...
            if (1 < h) {
                ...
                for (var h =
                    ...
                    if (m = a[g], m.parentNode == e.$ && g > k) { c.insertBefore(new CKEDITOR.dom.element(m)); break } else m = null;
                m || e.append(c)
            } else
        ...
        CKEDITOR.plugins.tabletools = {
            ...
            init: function(d) {
                ...
                b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", f({
                    ...
                    requiredContent: "table",
                    contentTransformations: [
                        [{ element: "td", left: function(a) { return a.styles.background && e.background(a.styles.background).color }, right: function(a) { a.styles["background-color"] = e.background(a.styles.background).color } }, { element: "td", check: "td{vertical-align}", left: function(a) { return a.attributes && a.attributes.valign }, right: function(a) { a.styles["vertical-align"] = a.attributes.valign;
                        ...
                        [{
                            ...
                            right: function(a) { CKEDITOR.tools.array.forEach(a.children, function(b) { b.name in { td: 1, th: 1 } && (b.attributes["cke-row-height"] = a.styles.height) });
                ...
                b("rowInsertBefore", f({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        a = q(a);
                        r(a, !0) } }));
                ...
                b("cellDelete", f({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        z(a) } }));
                ...
                b("cellMergeDown", f({
                    ...
                    exec: function(a, b) { b.cell = x(a.getSelection(), "down");
                        p(b.cell, !0) }
                }));
                b("cellVerticalSplit", f({ allowedContent: "td[rowspan]", requiredContent: "td[rowspan]", exec: function(a) { p(E(a.getSelection())) } }));
    ...
    (function() {
        function x(a, b) {
            ...
            for (c = 0; c < e[h].length; c++)
                if (a.$ === e[h][c]) { f = c; break } for (c = 0; c < e[m].length; c++)
                if (b.$ === e[m][c]) { p = c; break } f > p && (c = f, f = p, p = c);
            for (c = h; c <= m; c++)
        ...
        function G(a) { if (a) return a = a.clone(), a.enlarge(CKEDITOR.ENLARGE_ELEMENT), (a = a.getEnclosedNode()) && a.is && a.is(CKEDITOR.dtd.$tableContent) }

        function H(a) { return (a = a.editable().findOne(".cke_table-faked-selection")) && a.getAscendant("table") }
        ...
        function I(a) { var b = a.editable().find(".cke_table-faked-selection");
        ...
        function J(a, b, c) {
            ...
            else if (g.active && b && g.first.getAscendant("table").equals(b.getAscendant("table"))) { d = x(g.first, b); if (!g.dirty && 1 === d.length) return y(a, "mouseup" === c.name);
                g.dirty = !0;
                g.last = b;
                t(a, d) }
        }
        ...
        function K(a) {
            ...
            if (b && (y(a), b.isInTable() &&
                    b.isFake)) { 1 === c.length && c[0]._getTableElement() && c[0]._getTableElement().is("table") && (d = c[0]._getTableElement());
                d = u(b, d);
        ...
        function n(a) { return a.getAscendant("tr", !0).$.rowIndex }
        ...
        function M(a, b) {
            ...
            var d = a.getSelection(),
                ...
                p, r, B, g;
            h.getById("cke_table_copybin") || (p = h.createElement(f), r = h.createElement(f), r.setAttributes({ id: "cke_table_copybin", "data-cke-temp": "1" }), p.setStyles({ position: "absolute", width: "1px", height: "1px", overflow: "hidden" }), p.setStyle("ltr" ==
                a.config.contentsLangDirection ? "left" : "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), r.append(p), a.editable().append(r), g = a.on("selectionChange", c, null, null, 0), k && (B = l.scrollTop), m.selectNodeContents(p), m.select(), k && (l.scrollTop = B), setTimeout(function() { r.remove();
                d.selectBookmarks(e);
                g.removeListener();
                a.fire("unlockSnapshot");
        ...
        q.prototype.getTableMap = function() {
            ...
            a: { b = this.cells.last; var c = b.getAscendant("table"),
                    ...
                    e; for (e = 0; e < c[d].length; e++)
                    if ((new CKEDITOR.dom.element(c[d][e])).equals(b)) { b = e; break a } b = void 0 }
        ...
        q.prototype.insertRow = function(a, b, c) { if ("undefined" === typeof a) a = 1;
            else if (0 >= a) return; for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, h = c ? [] : this.cells.all, m, l = 0; l < a; l++) m = D(c ? this.cells.all : h, b), m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(), function(a) { return c ? !0 : a.$.cellIndex >= d && a.$.cellIndex <= e }), h = b ? m.concat(h) : h.concat(m);
            this.setSelectedCells(h) };
        q.prototype.insertColumn = function(a) {
            function b(a) { a = n(a); return a >= e && a <= h } if ("undefined" === typeof a) a = 1;
            else if (0 >= a) return; for (var c = this.cells, d = c.all, e = n(c.first), h = n(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(E(d), b));
            this.setSelectedCells(d) };
        q.prototype.emptyCells = function(a) { a = a || this.cells.all; for (var b = 0; b < a.length; b++) a[b].setHtml("") };
        q.prototype._arraySortByDOMOrder = function(a) { a.sort(function(a, c) { return a.getPosition(c) & CKEDITOR.POSITION_PRECEDING ? -1 : 1 }) };
        var F = {
            onPaste: function(a) {
                function b(a) {
                ...
                !h.length || 1 === h.length && !G(e.getRanges()[0]) && !l || l && !m || (h = h[0].getAscendant("table"), k = new q(u(e, h)), d.once("afterPaste", function() {
                    ...
                    t(d, a)
                }), m ? (a.stop(), l ? (k.insertRow(1, 1 === l, !0), e.selectElement(k.rows.first)) : (k.emptyCells(), t(d, k.cells.all)), a = k.getTableMap(), f = CKEDITOR.tools.buildTableMap(m), k.insertRow(f.length - a.length), k.insertColumn(b(f) - b(a)), a = k.getTableMap(), this.pasteTable(k, a, f), d.fire("saveSnapshot"), setTimeout(function() { d.fire("afterPaste") }, 0)) : (c(k.cells.first), d.once("afterPaste", function() { d.fire("lockSnapshot");
        ...
        CKEDITOR.plugins.tableselection = {
            ...
            keyboardIntegration: function(a) {
                function b(a) { var b = a.getEnclosedNode();
                ...
                c.attachListener(c, "keydown", function(a) {
                    function c(b, e) {
                        ...
                        var r = h[0].getBoundaryNodes(),
                            ...
                            r = r.endNode;
                        if (g && g.is && g.is(m)) {
                            for (var q = g.getAscendant("table", !0), n = g.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q), t = !1, u = function(a) { return !g.contains(a) && a.is && a.is("td", "th") }; n && !u(n);) n = n.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
        ...
        CKEDITOR.plugins.add("tableselection", {
            ...
            onLoad: function() { w = CKEDITOR.plugins.tabletools;
